...
export default function Home() {
  return (
    ...
    <main className="bg-background text-foreground min-h-screen overflow-x-hidden selection:bg-primary selection:text-primary-foreground">
      ...
      {/* 7b. ALSO BY */}
      <section
        className="py-24 md:py-32 px-6 border-t border-border relative"
        style={{ backgroundColor: 'hsl(35 10% 6%)' }}
      >
        {/* Subtle insects in the margins */}
        <FloatAnim baseRotation={-18} duration={8} delay={0.5} yRange={10} className="top-12 right-6 z-10 hidden sm:block">
          <InsectFlySVG size={36} opacity={0.62} />
        </FloatAnim>
        <FloatAnim baseRotation={22} duration={7} delay={2} yRange={8} className="bottom-16 left-8 z-10 hidden sm:block">
          <InsectFlySVG size={28} opacity={0.55} />
        </FloatAnim>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <FadeIn>
            <div className="mb-14">
              <div className="h-[1px] w-12 mb-8" style={{ backgroundColor: 'hsl(var(--ochre))' }} />
              <h2 className="font-mono text-xs uppercase tracking-[0.25em]" style={{ color: 'hsl(var(--muted-foreground))' }}>
                Also by Matthew Tait
              </h2>
            </div>
          </FadeIn>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 md:gap-16 max-w-3xl">

            {/* ── Deception Pass ──────────────────────────────────────── */}
            <FadeIn delay={0.15}>
              <article className="flex flex-col gap-5">
                {/* Cover placeholder — swap src for the real cover image */}
                <div
                  className="aspect-[2/3] w-full max-w-[180px] border border-border flex items-center justify-center relative overflow-hidden"
                  style={{ backgroundColor: 'hsl(100 10% 8%)' }}
                >
                  {/* Decorative placeholder until a real cover is supplied */}
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 px-4 text-center">
                    <DragonflySVG size={52} opacity={0.45} />
                ...
                <div className="flex flex-col gap-3">
                  <h3 className="text-xl md:text-2xl font-serif font-medium tracking-wide"
                      style={{ color: 'hsl(42 25% 84%)' }}>
                    Deception Pass
                  </h3>
                  <p className="font-sans text-sm md:text-base text-muted-foreground font-light leading-relaxed">
                    Winner of the Australasian Shadows Award for Best Novel — a descent into paranoia and
                    violence along Australia's coastal fringe.
                  </p>
                  {/* Buy link — swap href for the real product page */}
                  <a
                    href="https://www.amazon.com/s?k=Deception+Pass+Matthew+Tait"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block self-start font-mono text-xs uppercase tracking-[0.2em] px-5 py-2.5 border border-border hover:border-foreground transition-colors duration-300 mt-1"
            ...
            <FadeIn delay={0.3}>
              <article className="flex flex-col gap-5">
                ...
                >
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 px-4 text-center">
                    <InsectFlySVG size={42} opacity={0.40} />
                    <span className="font-mono text-[9px] uppercase tracking-[0.2em]"
                          style={{ color: 'hsl(var(--muted-foreground) / 0.5)' }}>
                      Cover coming soon
                    </span>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <p className="font-sans text-sm md:text-base text-muted-foreground font-light leading-relaxed">
                    Tait's 2014 novel of obsession and consequence — currently undergoing a ground-up rewrite,
                    with a new edition to come.
                  </p>
                  {/* Buy link — swap href for the real product page */}
                  <a
                    href="https://www.amazon.com/s?k=Davey+Ribbon+Matthew+Tait"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block self-start font-mono text-xs uppercase tracking-[0.2em] px-5 py-2.5 border border-border hover:border-foreground transition-colors duration-300 mt-1"
                    style={{ color: 'hsl(var(--foreground))' }}
